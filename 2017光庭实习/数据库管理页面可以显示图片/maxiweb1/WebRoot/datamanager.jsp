...
<%   Connection conn = null;
 conn =(Connection) DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/maxiWeb?characterEncoding=UTF-8", "maxi", "max940707");
	            
	            String createString ="SELECT * FROM maxiweb.maxiweb1 order by sid;";
...
<tr>
 ...
 while (rs.next()) {
	            	...
	            	out.println("  <td align=center>"+sname+"</td>");
                     String z="图片";
	            	if(sname.equals(z))
	            	out.println("  <td align=center>"+"<img src="+"'"+content+"'"+"width="+"'"+"300"+"'"+" height="+"'"+"100"+"'"+" />"+content+"</td>");
	            	else
...
// 						+ sid + "'>修改</a>");
	            	...
	            	out.println("     <a href='delete.jsp?action=edit&id="+sid+"'>删除</a>");
	            	out.println("</td>");
	            	out.println("</tr>");
