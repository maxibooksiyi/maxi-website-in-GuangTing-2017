...
<div class="mid">
  <div class="danei mid">
  <div class="midimage"><%db2 g14=new db2(); %><img src="<%=g14.jutishuchu(60) %>" width="980" height="300" /></div>
    <div class="con_left">
      <ul>
    ...
    <div class="con_right">
	  ...
	  <div class="biaozhun_image"><%db2 g15=new db2(); %><img src="<%=g15.jutishuchu(61) %>"  /></div>
	<!--/中部开始  <div class="tpwz">-->
	  <div class="jianjie">
	  <ul>
