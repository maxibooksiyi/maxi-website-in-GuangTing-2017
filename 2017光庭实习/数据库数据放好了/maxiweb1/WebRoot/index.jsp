  ...
  <div class="danei mid">
   <% db2 f=new db2();
     ...
     //这次至少说明参数是传递成功了的。
       ...
       %>
  <div class="midimage"><img src="<%= f.jutishuchu(21) %>" width="980" height="300" />  </div>
    <div class="con_left">
      <ul>
...
<!--             <span style="font-size:14px;">企业使命：以创新科技缔造安全、智能、高效的道闸广告媒体。</span><br /> -->
         ...
         <%db2 g8=new db2();out.println(g8.jutishuchu(2)); %>
          <!-- 看来我已经成功了，已经做到显示了下一步就是数据库的读取 ，现在我需要来写的就是数据库的读写与显示，这个功能在之前银行的那个是做过的。数据库的读取并显示，所以总体没什么难度，如果单单写在JSP里面的话。-->
