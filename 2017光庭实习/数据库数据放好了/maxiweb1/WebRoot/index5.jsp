...
<div class="mid">
  <div class="danei mid">
  <div class="midimage">
  <%db2 g10=new db2(); %><img src="<%=g10.jutishuchu(50) %>" width="980" height="300" /></div>
    <div class="con_left">
      <ul>
        <li><a href="blog.html" style="font-weight:bold;">媒体资源</a></li>
        <li><a href="blog.html" >合作伙伴</a></li>
       
      </ul>
    </div>
	<!--/下部文字部开始-->
    <div class="con_right">
      <div class="right_title">媒体资源：武汉点位图</div>
	  <div class="biaozhun_image"><%db2 g11=new db2(); %><img src="<%=g11.jutishuchu(52) %>"  /></div>
	  <div class="right_title">武汉合作伙伴</div>
	  <div class="biaozhun_image"><%db2 g12=new db2(); %><img src="<%=g12.jutishuchu(53) %>"  /></div>
	<!--/中部开始  <div class="tpwz">-->
